...
// ---- Monday 15 June: one full day, every area logged, with the staff named (a Jotla Plus day: photos and a video on the notes) ----
{
  ...
  kind: 'contemporaneous',
  type: 'quick',
  summary: 'Mr Adeyemi sat with him at breakfast club and he ate the lot.',
  photo: 'Photo from breakfast club'
}, {
  id: 'e22',
  childId: 'sam',
  date: '2026-06-15',
  ...
  kind: 'contemporaneous',
  type: 'quick',
  summary: 'Miss Hartley said phonics was his best session this term and asked us to practise the same sounds at home.',
  photo: 'Note from Miss Hartley'
}, {
  id: 'e28',
  childId: 'sam',
  date: '2026-06-15',
  ...
  kind: 'contemporaneous',
  type: 'quick',
  summary: 'First full day with no wobbles at line-up. Mrs Fenwick gave him a sticker in front of the class.',
  photo: 'Photo of the sticker chart'
}, {
  id: 'e29',
  childId: 'sam',
  date: '2026-06-15',
  ...
  kind: 'recalled',
  type: 'quick',
  summary: 'Multi-sports club. Coach Priya said he joined every game and helped pack away.',
  photo: 'Video noted (kept in your photo library)'
}, {
  id: 'm01',
  childId: 'maria',
  date: '2026-06-09',
...
function weekLead(dateObj) {
  return (dateObj.getDay() - weekStartDay() + 7) % 7;
}
