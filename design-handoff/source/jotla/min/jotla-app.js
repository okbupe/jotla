...
function ChildOptionsSheet({
  ...
  }, "Danger zone"), canDelete ? /*#__PURE__*/React.createElement("button", {
    className: "j-press",
  ...
  }, "Delete this child"), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'block',
  ...
  }, "Permanently remove ", profile.name, "'s record")), /*#__PURE__*/React.createElement(Icon, {
    name: "chevronRight",
    size: 18,
    color: "#E74C3C"
  })) : /*#__PURE__*/React.createElement("p", {
  ...
  }, "This is your only child record, so it cannot be deleted. Add another child first if you want to remove this one."))), delOpen && /*#__PURE__*/React.createElement(DeleteChildSheet, {
    profile: profile,
    entries: entries,
    docs: docs,
...
function DeleteChildSheet({
  ...
  const consequences = [[nEntries + (nEntries === 1 ? ' logged moment' : ' logged moments'), 'Every quick log and gate note you have written.'], [nDocs + (nDocs === 1 ? ' saved document' : ' saved documents'), 'Letters, reports and plans kept in the vault.'], [name + "'s profile", 'Their name, avatar, colour and settings.']];
  return /*#__PURE__*/React.createElement("div", {
    className: "j-sheet-scrim",
    onClick: onClose,
    style: {
  ...
  }, "Delete ", name, "'s record?"), /*#__PURE__*/React.createElement("p", {
    className: "j-body",
    style: {
      textAlign: 'center',
      color: 'var(--muted)',
  ...
  }, "This permanently erases everything below. It cannot be undone, and because nothing leaves this phone there is no copy we can restore for you."), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Back up first."), " Save a copy of ", name, "'s record to your phone before you delete. You can keep it, or reimport it later.")), backedUp ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8,
    ...
    size: 20,
    color: "#fff"
  }), " Continue to delete"), /*#__PURE__*/React.createElement("button", {
    className: "j-btn j-btn-ghost",
    onClick: onClose
  }, "Keep this record")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", {
    className: "j-h2",
    style: {
      textAlign: 'center',
      marginBottom: 6
  ...
  }, backedUp ? 'Your backup is saved. ' : 'You have not made a backup. ', "To finish, confirm you understand and type DELETE."), /*#__PURE__*/React.createElement("button", {
    className: "j-press",
    onClick: () => setAck(a => !a),
    style: {
      width: '100%',
  ...
  }, "I understand this permanently deletes ", name, "'s record and everything in it.")), /*#__PURE__*/React.createElement("input", {
    className: "j-input",
    value: typed,
    ...
    size: 20,
    color: "#fff"
  }), " ", 'Delete ' + name + "'s record permanently"), /*#__PURE__*/React.createElement("button", {
    className: "j-btn j-btn-ghost",
...
function App({
  ...
  }, [dark, tscale, profileId, plus, childCfg, customProfiles, deletedIds]);
  ...
  }, !isFullscreen && /*#__PURE__*/React.createElement(AppHeader, {
    profile: profile,
    plus: plus,
  ...
  }, /*#__PURE__*/React.createElement(ScreenBoundary, null, window.__JOTLA_TEST_THROW ? /*#__PURE__*/React.createElement(CrashProbe, null) : screen))), isTab && /*#__PURE__*/React.createElement(TabBar, {
    active: tab,
    onTab: nav.setTab,
  ...
  }, "Swipe back again to close Jotla")), profileOpen && /*#__PURE__*/React.createElement(ProfileSheet, {
    profiles: profiles,
    activeId: profileId,
    onPick: id => {
      setProfileId(id);
  ...
  }), childOptOpen && /*#__PURE__*/React.createElement(ChildOptionsSheet, {
    profile: profile,
    entries: myEntries,
    docs: myDocs,
